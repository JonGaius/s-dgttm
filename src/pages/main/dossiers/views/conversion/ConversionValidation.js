...
const ConversionValidation = ({title}) => {
    ...
    return (
        ...
        <FileDarianne actuel={'Dossiers Conversion en attente de validation'}>
            <OldFileDariane link={'/'}>
                Accueil
            </OldFileDariane>
                            ...
                            tableElement.map((element) => (
                                <div className='sigepec-table__body' key={element.id}>
                                    ...
                                    <div className='sigepec-table__column is--auto'>
                                       <Link to={`/gestion-des-dossiers/valider/conversions/${element.slug}`}><span>{element.nom + " " + element.prenom} </span></Link> 
                                    </div>
                                    <div className='sigepec-table__column is--lilmed'>
                                        {
                                            (element.statut === 0) ? 

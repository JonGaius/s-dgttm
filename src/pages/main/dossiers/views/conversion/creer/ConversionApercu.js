...
const ConversionApercu = (title) => {
    document.querySelector('title').innerHTML = "Apercu" + ' | SIGEPEC';
    ...
    const [typeP, setTypeP] = useState(state.typeP);
    ...
    const [categoryO, setCategoryO] = useState(state.categoryO);
    ...
    const [dateDelivrance, setDateDelivrance] = useState(state.dateDelivrance);
    const [lieuDelivrance, setLieuDelivrance] = useState(state.lieuDelivrance);
    const [restriction, setRestriction] = useState(state.restriction);
    ...
    const [scanPermis, setScanPermis] = useState(state.scanPermis);
...
export default ConversionApercu;
...
const DuplicataIdCard = ({title}) => {
    ...
    return (
        <DossierLayout here={'list'}>
            <FileDarianne actuel={'Gestion des Dossiers Duplicata idcard'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des dossiers duplicata idcard</h2>
                    <div className='sigepec-module-dossier-list__actions has--flex'>
                        ...
                        <BtnLink link={'/gestion-des-dossiers/creer/duplicata-idcard'} style={'is--primary'}>
                            ...
                            tableElement.map((element) => (
                                <div className='sigepec-table__body' key={element.id}>
                                    ...
                                    <div className='sigepec-table__column is--auto'>
                                       <Link to={`/gestion-des-dossiers/voir/duplicata-idcard/${element.slug}`}><span>{element.numIdcard} </span></Link> 
                                    </div>
                                    <div className='sigepec-table__column is--lilmed'>
                                        {
                                            (element.statut === 0) ? 
                                    ...
                                    <div className='sigepec-table__column is--little'>
                                        ...
                                        <div className='sigepec-table__option' id={element.slug}>
                                            <Link to={`/gestion-des-dossiers/modifier/duplicata-idcard/${element.slug}`}>
                                                Modifier
                                            </Link>
                                            <button type='button'>
                                                Supprimer
...
export default DuplicataIdCard;
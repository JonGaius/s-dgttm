...
const DuplicataIdCardDossierValides = ({title}) => {
    ...
    return (
        <DossierLayout here={'valide'}>
            <FileDarianne actuel={'Dossiers Duplicata idCard validés'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des dossiers duplicata idcard validés</h2>
...
export default DuplicataIdCardDossierValides;
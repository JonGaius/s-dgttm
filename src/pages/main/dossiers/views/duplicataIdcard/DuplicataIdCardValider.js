...
const DuplicataIdCardValider = ({title}) => {
    ...
    return (
        <DossierLayout here={'validation'}>
            <FileDarianne actuel={'Validation d\'un Dossier Duplicata idcard'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
                ...
                <OldFileDariane link={'/gestion-des-dossiers/duplicata-idcard'}>
                    Gestion des Dossiers Duplicata idCard
                </OldFileDariane>
                <OldFileDariane link={'/gestion-des-dossiers/validation-de-dossier/duplicata-idcard'}>
                    Gestion des Dossiers Duplicata idCard en attente de validation
                </OldFileDariane>
            </FileDarianne>
                    ...
                    <div className="sigepec-module-add-section__container">
                        <div className='sigepec-module-add-section__box'>
                                ...
                                <div className="sigepec-module-add-apercu__items has--flex_between is--large">
                                    ...
                                    <div className="sigepec-module-add-apercu__item is--large has--flex_between">
                                        <span>Date de dépôt :</span><strong>{'12/01/2020'}</strong>
                                    </div>
                                </div>
                                <div className="sigepec-module-add-apercu__items has--flex_between is--large">
                                    <div className="sigepec-module-add-apercu__item is--large has--flex_between">
                    ...
                    <div className='sigepec-modal__body sigepec-module-dossier-mmodal'>
                        ...
                        <div className="sigepec-module-add-form__container is--large has--flex">
                            ...
                            <FileField id={'certificat'} accept={''}  dvalue={scanCertificat} fnc={changeScanCertificat}>
                                Scan du certificat d’authenticité de la carte
                            </FileField>
                        </div>
...
export default DuplicataIdCardValider;
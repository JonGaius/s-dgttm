...
const EchangeList = ({title}) => {
    ...
    return (
        <DossierLayout here={'list'}>
            <FileDarianne actuel={'Gestion des dossiers Echange'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des dossiers d'echange</h2>
                    <div className='sigepec-module-dossier-list__actions has--flex'>
                        ...
                        <BtnLink link={'/gestion-des-dossiers/creer/echange'} style={'is--primary'}>
                            ...
                            tableElement.map((element) => (
                                <div className='sigepec-table__body' key={element.id}>
                                    ...
                                    <div className='sigepec-table__column is--auto'>
                                       <Link to={`/gestion-des-dossiers/voir/echange/${element.slug}`}><span>{element.nom + " " + element.prenom} </span></Link> 
                                    </div>
                                    <div className='sigepec-table__column is--lilmed'>
                                        {
                                            (element.statut === 0) ? 

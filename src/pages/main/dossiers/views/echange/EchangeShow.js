...
const EchangeShow = ({title}) => {
    ...
    return (
        ...
        <DossierLayout here={'list'}>
            <FileDarianne actuel={'Aperçu d\'un dossier Echange'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-add is--large has--flex_between'>
                ...
                <div className="sigepec-module-add__section">
                    ...
                    <div className="sigepec-module-add-section__container">
                        ...
                        <div className='sigepec-h-bar'></div>
                        <div className='sigepec-module-add-files'>
                            <Link to={`/gestion-des-dossiers/modifier/echange/${params.slug}`} className="sigepec-module-list__action is--large has--flex">
                                <EditIcon/> <span>Modifier les informations du dossier</span>
                            </Link>
                            <Link to={`/gestion-des-dossiers/valider/echange/${params.slug}`} className="sigepec-module-list__action is--large has--flex">

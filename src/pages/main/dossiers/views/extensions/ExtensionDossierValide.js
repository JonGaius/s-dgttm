...
const ExtensionDossierValide = ({title}) => {
    ...
    return (
        <DossierLayout here={'valide'}>
            <FileDarianne actuel={'Dossiers Extension validés'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des dossiers d'extension validés</h2>
...
export default ExtensionDossierValide;
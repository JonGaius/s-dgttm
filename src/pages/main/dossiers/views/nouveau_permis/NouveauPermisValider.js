...
const NouveauPermisValider = ({title}) => {
    ...
    return (
        ...
        <FileDarianne actuel={'Validation d\'un Dossier Nouveau Permis'}>
            <OldFileDariane link={'/'}>
                Accueil
            </OldFileDariane>
            ...
            <OldFileDariane link={'/gestion-des-dossiers/validation-de-dossier/nouveaux-permis'}>
                Gestion des Dossiers Nouveau Permis en attente de validation
            </OldFileDariane>
        </FileDarianne>
            ...
            <div className='sigepec-module-add is--large has--flex_between'>
                    ...
                    <div className="sigepec-module-add-section__container">
                        <div className='sigepec-module-add-section__box'>
                            ...
                            <div className='sigepec-module-add-apercu-btn has--flex_between'>
                                <Checkbox id={'cpersonal'} style={'is--large'}> 
                        ...
                        <div className='sigepec-module-add-section__box'>
                            ...
                            <div className='sigepec-module-add-apercu-btn has--flex_between'>
                                <Checkbox id={'caddress'} style={'is--large'}> 
                                    Valider les informations
                                </Checkbox>
                ...
                <div className="sigepec-module-add__section">
                    <div className="sigepec-module-add-section__container">
                        ...
                        <div className='sigepec-module-add-apercu-btn has--flex_between'>
                            <Checkbox id={'scan'} style={'is--large'}> 
                                Valider les informations
                            </Checkbox>
...
export default NouveauPermisValider;
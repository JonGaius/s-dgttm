...
const ValidationDossier = ({title}) => {
    ...
    return (
        ...
        <FileDarianne actuel={'Dossiers Nouveau Permis en attente de validation'}>
            <OldFileDariane link={'/'}>
                Accueil
            </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des dossiers en attente de validation</h2>
                            ...
                            tableElement.map((element) => (
                                <div className='sigepec-table__body' key={element.id}>
                                    ...
                                    <div className='sigepec-table__column is--auto'>
                                       <Link to={`/gestion-des-dossiers/valider/nouveaux-permis/${element.slug}`}><span>{element.nom + " " + element.prenom} </span></Link> 
                                    </div>
                                    <div className='sigepec-table__column is--lilmed'>
...
export default ValidationDossier;
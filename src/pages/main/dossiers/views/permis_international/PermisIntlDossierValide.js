...
const PermisIntlDossierValide = ({title}) => {
    ...
    return (
        <DossierLayout here={'valide'}>
            <FileDarianne actuel={'Dossiers Permis internationaux validés'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des permis internationaux validés</h2>
...
export default PermisIntlDossierValide;
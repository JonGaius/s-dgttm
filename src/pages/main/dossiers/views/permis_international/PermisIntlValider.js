...
const PermisIntlValider = ({title}) => {
    ...
    return (
        <DossierLayout here={'validation'}>
            <FileDarianne actuel={'Dossier Permis internationaux en attente de validation'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des permis internationaux en attente de validation</h2>
                        ...
                        </div>
                        {
                            tableElement.map((element) => (
                                <div className='sigepec-table__body' key={element.id}>
                                    ...
                                    <div className='sigepec-table__column is--lilmed'>
                                    <Link to={`/gestion-des-dossiers/valider/permis-internationaux/${element.slug}`}><span>{element.numPermis}</span></Link> 
                                    </div>
...
export default PermisIntlValider;
...
const RemplacementIdCardValidation = ({title}) => {
    ...
    return (
        <DossierLayout here={'validation'}>
            <FileDarianne actuel={'Dossiers Remplacement Idcard en attente de validation'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
            ...
            <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des dossiers remplacement idcard en attente de validation</h2>
                            ...
                            tableElement.map((element) => (
                                <div className='sigepec-table__body' key={element.id}>
                                    ...
                                    <div className='sigepec-table__column is--auto'>
                                       <Link to={`/gestion-des-dossiers/valider/remplacement-idcard/${element.slug}`}><span>{element.numIdcard} </span></Link> 
                                    </div>
                                    <div className='sigepec-table__column is--lilmed'>
                                        {
                                            (element.statut === 0) ? 
...
export default RemplacementIdCardValidation;
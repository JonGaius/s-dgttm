...
const ProgrammationCirculation = ({title}) => {
    ...
    const [exam, setExam] = useState('Circulation');
    ...
    const automatique = () => {
        ...
        navigate('/gestion-des-examens/programmations/apercu', {
            state: {
                ...
                langue: langue,
                salle: salle,
                url: '/gestion-des-examens/programmations/circulation',
            }
        })
    }
            ...
            <FileDarianne actuel={'Circulation'}>
             ...
             <div className='sigepec-module-dossier-list'>
                <div className='sigepec-module-dossier-list__head has--flex_between is--large'>
                    <h2>Liste des programmations - Circulation</h2>
...
export default ProgrammationCirculation;
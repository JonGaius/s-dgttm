...
const QuestionCreer = ({title}) => {
    ...
    return (
        ...
        <QuestionnaireLayout title={title} here='question'>
            <FileDarianne actuel={'Ajout d\'un questionnaire'}>
                <OldFileDariane link={'/'}>
                    Accueil
                </OldFileDariane>
                                ...
                                <div className="sigepec-field-largefile__action">
                                        <div className="sigepec-field-largefile-actions has--flex">
                                            <div className="sigepec-field-largefile-action">
                                                <input type="file" id='image' onChange={changeImage} accept='.jpeg,.png,.jpg' required/>
                                                <label htmlFor="image">
                                                    <ImageIcon/>
                                            ...
                                            <div className="sigepec-field-largefile-action">
                                                <input type="file" id='video' accept='.mp4,.avi,.gif' required/>
                                                <label htmlFor="video">
                                                    <FilmIcon/>
